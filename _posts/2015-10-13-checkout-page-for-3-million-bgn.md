...
Тази държавна поръчка е за разработката на такава *"страницата за плащане"* с опцията за проверка на задължения. Не става дума за разработване на нов начин за плащане, а за интеграцията на съществуващите такива. Това беше и демонстрираното на пресконференцията.
...
Базирано на това описание и документацията може да видим, че реално резултата на проектът е:
 ...
 - **интеграция на системата** с няколко администрации (*указано е поне 2*) 
