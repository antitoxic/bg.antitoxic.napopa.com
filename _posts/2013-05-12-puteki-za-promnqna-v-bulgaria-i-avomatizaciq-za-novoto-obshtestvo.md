...
<p class="bleed">
<iframe height='450' frameborder='0' src='https://docs.google.com/spreadsheet/pub?key=0AoQEIaPHnvx6dHVWTDJIUDBrN0FEOURzMUZaRnFTTXc&single=true&gid=0&output=html&widget=true'></iframe>
</p>
...
***Редакция:*** Откакто пуснахме статията се включиха: *(по ред на включване)*
 ...
 - <abbr title="Разработчик (FrontEnd)">**Васил Бачев**</abbr>
 - <abbr title="Разработчик, от създатели те на extension-а ignorepeevski">**Димитър Димитров**</abbr>
 - <abbr title="Юрист">**Станимир Ненов**</abbr>
 - <abbr title="Разработчик">**Стефан Жеков**</abbr>
 - <abbr title="Дизайнер">**Екатерина Тодева**</abbr>
 - <abbr title="Илюстратор">**Евелина Желязкова**</abbr>
 - <abbr title="Разработчик, open data България">**Боян Юруков**</abbr>
 - <abbr title="Предприемач">**Александър Ангелов**</abbr>
 - <abbr title="Разработчик">**Йордан Миладинов**</abbr>
 - <abbr title="Разработчик (Frontend)">**Боян Тодоров**</abbr>
 - <abbr title="Разработчик (Backend)">**Мартин Христов**</abbr>

***Редакция 2:*** На път сме вече да организираме НПО. В момента се работи [по няколко проекта](https://github.com/obshtestvo/).
