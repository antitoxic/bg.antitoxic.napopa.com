...
***Редакция:*** Откакто пуснахме статията се включиха <abbr title="Лектор в академията на Телерик и участник в NASA Chanllenge">**Павел Колев**</abbr> и <abbr title="Бизнес Анализ">**Стоян Атипов**</abbr>!
